...
class robot:
    def abrir_navegador(self):
        ...
        with sync_playwright() as p:
            ...
            self.login(page, login1, senha1)
            sleep(10)
            self.buscar_voo(page, origem1, destino1, data_ida1)

    def login(self, page, login1, senha1):
        try:
    ...
    def buscar_voo(self, page, origem1, destino1, data_ida1):
